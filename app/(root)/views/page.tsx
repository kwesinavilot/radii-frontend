...
//         <div className="h-screen overflow-y-auto sm:col-span-3 py-4 m-4 sm:px-16 bg-white border border-gray-200 rounded-lg shadow dark:bg-white dark:border-gray-300">
//           <div className="mb-4">
...
//                 <div key={index} className="border p-4 rounded shadow-sm  py-6">
//                   <div
...
//                         <h2>{truncateName(chart.name, 20)}</h2>
//                         <p className="text-gray-500">
...
//                 <h2 className="text-2xl font-bold mb-4">Create New View</h2>
//                 <div className="mb-4">
//                   <input
//                     type="text"
