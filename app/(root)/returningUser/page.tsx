...
//         <div className="block sm:col-span-1 py-4 px-2 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-100">
//           <div className="block overflow-hidden bg-white transition-transform transform hover:scale-105">
//             <div className="flex justify-between px-8 py-2 border-b-2 border-neutral-500 dark:border-black/10">
//               <h2 className="font-semibold"> Recent Search</h2>
//             </div>
//             <div className="divide-y divide-gray-200 dark:divide-black/10">
//               {recentSearches.map((item) => (
//                 <div
//                   key={item.searchID}
//                   className="flex items-center justify-between px-8 py-2 cursor-pointer hover:bg-gray-100"
//                   onClick={() => handleUserQueriesClick(item.searchID)}
//                 >
//                   <h2 className="font-medium text-sm">{item.query}</h2>
