...
//         "https://starfish-app-9ezx5.ondigitalocean.app/auth/account-exists/",
//         {
...
// import { updateRegistrationData } from "./store/slices/registrationSlice";
  ...
  const handleGoogleSignUp = useGoogleLogin({
    onSuccess: async (response) => {
      ...
      try {
        ...
        toast.error(
          "An error occurred while fetching Google profile. Please try again."
        );
      }
    },
    onError: (error) => {
